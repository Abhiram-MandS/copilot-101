...
export const Dashboard = () => {
  ...
  const { progress, resetProgress, getCompletionPercentage } = useProgress();
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-100">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="max-w-md mx-auto">
            <div className="flex justify-between items-end mb-3 px-1">
              ...
              <span className="text-2xl font-mono font-bold text-slate-900">{completionPercentage}%</span>
            </div>
      ...
      {completionPercentage === 100 && (
        <div className="fixed bottom-8 right-8 bg-green-600 text-white px-6 py-4 rounded-lg shadow-lg animate-bounce">
          <p className="font-bold">🎉 Training Complete!</p>
          <p className="text-sm">You've mastered GitHub Copilot!</p>
        </div>
      )}
